...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name = "R.2 Block Alliance")
public class R2BlockAlliance extends LinearOpMode { // extends LinearOpMode
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafeRight(29,0.5,900 );
        backward(42,0.75, 2400);
        armRelease();
        forward(49.5,0.75, 3000);
        strafeLeft(29,0.5, 1000);
        armGrab();
        strafeLeft(1,0.25,100 );
        strafeRight(25,0.5,900 );
        backward(58,0.75, 3000);
        armRelease();
        strafeRight(5.75,0.5,400);
        forward(17,0.75,1475);
    ...
    public void backward(double inches, double power, int time) {
        drive(-inches, power-0.20, power, time);
    }//backwards
