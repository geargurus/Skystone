...
@Autonomous(name="GGTEST0", group="XxX")
	...
	*/
    ...
    public void verticalDrive(double inches, double leftPower, double rightPower)
    {
                ...
                !isStopRequested())
        {
            ...
            frontLeft.setPower(leftPower);
            frontRight.setPower(rightPower-.05);
            backLeft.setPower(leftPower-.05);
            backRight.setPower(rightPower);
            if(backLeft.getCurrentPosition()<frontLeft.getCurrentPosition())//if we veer leftward
            {
                if(rightPower<.5 && leftPower<.5)
                {
                    leftPower+=.01;
            ...
            else if(true)//if we veer rightward
            {
                if(rightPower<.5 && leftPower<.5)
                {
                    rightPower+=.01;
    ...
    public void horizontalDrive(double inches, double frontPower, double backPower)
    {
                ...
                !isStopRequested())
        {
            ...
            frontRight.setPower(frontPower-.05);
            backLeft.setPower(backPower-.05);
