...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name = "R.2 Block Neutral")
public class R2BlockNeutral extends LinearOpMode { // extends LinearOpMode
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafeLeft(26,0.75, 1200);
        armGrab();
        strafeLeft(1,0.25,100 );
        strafeRight(9,0.5,900 );
        backward(42,0.75, 2700);
        armRelease();
        strafeLeft(5,0.5,500);
        forward(55,0.75, 3000);
        strafeLeft(16,0.5, 1000);
        armGrab();
        strafeLeft(1,0.25,100 );
        strafeRight(14,0.5,900 );
        backward(58,0.75, 3000);
        armRelease();
        strafeLeft(10,0.5,400);
        forward(20,0.75,1475);
    ...
    public void backward(double inches, double power, int time) {
        drive(-inches, power-0.10, power, time);
    }//backwards
