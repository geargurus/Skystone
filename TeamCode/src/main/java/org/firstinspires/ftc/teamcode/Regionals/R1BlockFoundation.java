...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous (name = "R.1 Block Foundation ")
public class R1BlockFoundation extends LinearOpMode { // extends LinearOpMode
